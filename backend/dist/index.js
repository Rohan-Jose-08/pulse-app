...
exports.app.get('/api/pulses/:id', authenticateUser, async (req, res) => {
    try {
        const { id } = req.params;
...
exports.app.post('/api/pulses', authenticateUser, async (req, res) => {
    try {
...
exports.app.put('/api/pulses/:id', authenticateUser, async (req, res) => {
    try {
        const { id } = req.params;
...
exports.app.patch('/api/pulses/:id', authenticateUser, async (req, res) => {
    try {
        const { id } = req.params;
...
exports.app.post('/api/pulses/:id/join', authenticateUser, async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user.id;
...
exports.app.post('/api/pulses/:id/leave', authenticateUser, async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user.id;
        // Check if pulse exists
...
exports.app.get('/api/pulses/:id/participants', authenticateUser, async (req, res) => {
    try {
        const { id } = req.params;
        // Find the pulse with author and participants information
        const pulse = await prisma.pulse.findUnique({
...
exports.app.post('/api/pulses/:id/chat', authenticateUser, async (req, res) => {
    try {
        const { id } = req.params;
...
exports.app.get('/api/pulses/:id/chat', authenticateUser, async (req, res) => {
...
exports.app.get('/api/pulses/:id/chat/messages', authenticateUser, async (req, res) => {
    try {
        const { id } = req.params;
        const me = req.user.id;
...
exports.app.post('/api/pulses/:id/chat/messages', authenticateUser, async (req, res) => {
    try {
        const { id } = req.params;
        const me = req.user.id;
